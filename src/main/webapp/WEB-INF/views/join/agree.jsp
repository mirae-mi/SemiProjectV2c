        ...
        <div id="main">
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <span class="badge badge-light" style="padding: 8px">실명확인</span>
                    </li>
                    <li class="breadcrumb-item">
            ...
            <div class="mt25">
                ...
                <small class="text-muted">
                    회원가입을 위해서 아래 사이트 이용약관 &middot; 개인정보 수집 및 이용에 대한 안내를 읽고 동의해 주세요.
                </small>
                <hr>
            </div>
...
Copyright © Kakao Corp. All rights reserved.
                    ...
                    <div class="custom-control custom-check text-right">
...
시행일자: 2021년 12월 07일
            ...
            <div class="text-center" style="margin-bottom: 10px"><!-- 버튼은 text 정렬이 된다 (안될 때도 있....) -->
                <button type="button" id="okagree" class="btn btn-success">모두 동의합니다</button>
            <button type="button" id="noagree" class="btn btn-danger">모두 동의하지 않습니다</button>
            </div><!-- 버튼들 -->
